#
#  Be sure to run `pod spec lint IMEPay.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/ManojKarkie/IMEPay.git", :tag => "0.0.2" }
  ...
  s.source_files  = "IMEPay", "IMEPay/**/*.{h,m}"
  ...
  # s.resource  = "icon.png"
  s.resources = "IMEPay/Assets/*.{png,storyboard}"
